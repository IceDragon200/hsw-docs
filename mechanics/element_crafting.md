...
Non-player based Element Crafting is also locked behind near-endgame machines.

It's primary usecase however is the creation of WME and it's respective tools which are very low grade tools that can be used for crafting or harvesting items in the world.
