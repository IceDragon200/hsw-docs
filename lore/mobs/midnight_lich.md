...
flowchart LR
  lich{"Midnight Lich"}
  gift["Give Apple"]
  fight["Attack Midnight Lich"]
  avione["Avione"]
  lich --> fight & gift --> avione
```
...
This will immediately transition them to their NPC [Avione](/lore/characters/avione.md).
...
They will re-appear from then on as the NPC [Avione](/lore/characters/avione.md).

## Loot

Either upon defeat or by pacifying the Midnight Lich they will immediately add the [Bio Lab Access Card](/lore/items/bio_lab_access_card.md)
